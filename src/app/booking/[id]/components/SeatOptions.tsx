    ...
    <div className="inline-flex w-96 flex-col items-center justify-start gap-4 rounded-lg px-2 py-8">
      ...
      <div className="flex h-60 flex-col gap-4">
        <div className="inline-flex w-36 items-start justify-start gap-4">
          ...
          {badge && (
            <div
              className={`flex items-center justify-start gap-2.5 rounded px-1.5 py-0.5 ${badgeClass}`}
            >
              <div className="whitespace-nowrap text-sm font-bold leading-none text-white">
                {badge}
              </div>
            </div>
          )}
        </div>
        <div className="self-stretch whitespace-pre-line text-sm font-normal text-slate-400">
          {description}
        </div>
        <div className={`h-1 w-8 p-1 opacity-50 ${benefitColorClass}`} />
        <ul>
  ...
  const economySeatIcon = (
    ...
    >
      ...
      <defs>
        ...
        >
          <stop stopColor="#BCBAF7" />
          <stop offset="1" stopColor="#8684F1" />
        </linearGradient>
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop offset="0.0208333" stopColor="#9D8CF2" />
          <stop offset="0.567708" stopColor="#707FF2" />
          <stop offset="1" stopColor="#266AF2" />
        </linearGradient>
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop stopColor="#4413A0" />
          <stop offset="0.520833" stopColor="#3D13A0" />
          <stop offset="1" stopColor="#1513A0" />
        </linearGradient>
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop stopColor="#CBD4E6" />
          <stop offset="0.321516" stopColor="#ACC5F6" />
          <stop offset="1" stopColor="#CBD4E6" />
        </linearGradient>
        <linearGradient
    ...
    >
      ...
      <defs>
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop stopColor="#BAECF7" />
          <stop offset="1" stopColor="#84DDF1" />
        </linearGradient>
        <linearGradient
        ...
        >
          ...
          <stop offset="0.567708" stopColor="#70F2F2" />
          <stop offset="1" stopColor="#26AEF2" />
        </linearGradient>
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop stopColor="#4A7DDF" />
          <stop offset="1" stopColor="#3595F4" />
        </linearGradient>
        <linearGradient
  ...
  const seatInfo: SeatInfo[] = [
    {
      ...
      benefitColorClass: "bg-emerald-500",
    ...
    },
    {
      ...
      benefitColorClass: "bg-yellow-500",
      badge: "Premium",
